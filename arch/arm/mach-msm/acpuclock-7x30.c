...
static struct clkctl_acpu_speed acpu_freq_tbl[] = {
	...
	{ 1, 1612800, PLL_2, 3, 0, 192000000, 1400, VDD_RAW(1400), &pll2_tbl[6]},
	{ 1, 1708800, PLL_2, 3, 0, 192000000, 1400, VDD_RAW(1400) ,&pll2_tbl[7]},
	{ 1, 1804800, PLL_2, 3, 0, 192000000, 1450, VDD_RAW(1450) ,&pll2_tbl[8]},
	{ 0 }
#else
	{ 0 }
#endif
